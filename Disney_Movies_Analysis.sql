/* Insights on Disney Movies Gross
 -- For this analysis, I will be using a dataset contains all
 -- 579 movies betwem 1937 and 2016 released by Disney
 -- and the top 20% Movies that brought 80% of Disney's Gross Income
*/
--
...
-- Conclusion: From the above findings, we would notice "Snow White and the Seven Dwarfs" 
-- is the highest movie by Inflation Adjusted Gross which is 7.6% of the entire gross income
-- earned by Dinsey and it happens to be very first movie released. It must have been a hit.
-- Most with the high gross incomes are rated G and are mainly Adventures. Lastly, Disney earned more income
-- from the Top 7 Movies which are 20%  out of the 100% inflation adjusted gross
-- of movies released from 1937 - 2013.